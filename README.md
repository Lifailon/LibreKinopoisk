...
- Вы можете вызывать интерфейс поиска раздач в торрент трекерах находясь на любой странице браузера, а также изменить адрес сервера **TorAPI** и настроить отображение кнопок в интерфейсе расширения:

<h1 align="center">
    <img src="image/popup-interface.jpg" width="400"/></a> <img src="image/popup-settings.jpg" width="400"></a>
</h1>

Что бы запустить свой API сервер в Docker контейнере или развернуть его на **Vercel**, воспользуйтесь инструкций в репозитории на [GitHub](https://github.com/Lifailon/TorAPI).
