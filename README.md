...
Для использования расширения на устройстве Android, вы можете воспользоваться [Kiwi Browser](https://kiwibrowser.com) и инструкцией по [установке](#-установка) выше. Интерфейс поиска раздач доступен через интерфейс расширения. При использовании магнитных ссылок через кнопку `Скачать`, устройтсво автоматически определит ваш торрент клиент по умолчанию (например, [Libre Torrent](https://github.com/proninyaroslav/libretorrent)) или предложит выбор, после чего сразу начнется загрузка метаданных раздачи. Для работоспособности кнопок на сайте Кинопоиск, включите режим `Версия для ПК` и отключилите блокировку рекламы для текущего сайта.

<h1 align="center">
    <img src="image/android-download.jpg" width="400"/></a> <img src="image/android-libretorrent.jpg" width="400"></a>
</h1>
